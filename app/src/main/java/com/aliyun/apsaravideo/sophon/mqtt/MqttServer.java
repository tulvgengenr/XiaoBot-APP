package com.aliyun.apsaravideo.sophon.mqtt;
...
public class MqttServer extends Service {
    ...
    private static String TAG = "Android_MQTT";
    @SuppressLint("StaticFieldLeak")
    private static MqttAndroidClient mqttAndroidClient;
    private MqttConnectOptions mMqttConnectOptions;

    public String HOST = "tcp://47.113.184.248:1883";//服务器地址（协议+地址+端口号）
    public String USERNAME = "admin";//用户名
    public String PASSWORD = "Gfacljz001028";//密码

    public static String PUBLISH_TOPIC = "messageApptoCar";//发布主题
    public static String RESPONSE_TOPIC = "messageCartoApp";//响应主题
    ...
    public String CLIENT_ID = "XiaoVideo";
    ...
    public static void sentUp() {
        publish(UP);
    }
    public static void sentDown() {
        publish(DOWN);
    }
    public static void sentLeft() {
        publish(LEFT);
    }
    public static void sentRight() {
        publish(RIGHT);
    }
